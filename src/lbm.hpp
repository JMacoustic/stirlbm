...
public:
	...
	public:
		...
		bool next_frame(const ulong total_time_steps, const float video_length_seconds, const uint fps); // returns true once simulation time has progressed enough to render the next video frame for a 60fps video of specified length
